import { ARRAY_START_TOKEN, ARRAY_END_TOKEN, INTEGER_SMALL_POS_TOKEN, STRING_TOKEN, ARRAY_REPEAT_TOKEN, ARRAY_REPEAT_MANY_TOKEN, OBJECT_START_TOKEN, UNREFERENCED_STRING_TOKEN, OBJECT_END_TOKEN, TEMPLATE_OBJECT_START, TEMPLATE_OBJECT_END, TEMPLATE_OBJECT_FINAL, INTEGER_SMALL_NEG_TOKEN, UNDEFINED_TOKEN } from '../../src/constants';
...
const testCases = [
  ...
  new TestCase('single-number',
    [1],
    [ARRAY_START_TOKEN, INTEGER_SMALL_POS_TOKEN[1], ARRAY_END_TOKEN]
  ),

  new TestCase('two-numbers',
    [1, 2],
    [ARRAY_START_TOKEN, INTEGER_SMALL_POS_TOKEN[1], INTEGER_SMALL_POS_TOKEN[2], ARRAY_END_TOKEN],
  ),
  ...
  new TestCase('repeated-once',
    [1, 1],
    [ARRAY_START_TOKEN, INTEGER_SMALL_POS_TOKEN[1], ARRAY_REPEAT_TOKEN, ARRAY_END_TOKEN],
  ),

  new TestCase('repeated-five',
    [1, 1, 1, 1, 1],
    [ARRAY_START_TOKEN, INTEGER_SMALL_POS_TOKEN[1], ARRAY_REPEAT_TOKEN, ARRAY_REPEAT_TOKEN, ARRAY_REPEAT_TOKEN, ARRAY_REPEAT_MANY_TOKEN, '1', ARRAY_END_TOKEN],
  ),

  new TestCase('repeated-not-repeated-repeated',
    [1, 1, 2, 1, 1],
    [ARRAY_START_TOKEN, INTEGER_SMALL_POS_TOKEN[1], ARRAY_REPEAT_TOKEN, INTEGER_SMALL_POS_TOKEN[2], INTEGER_SMALL_POS_TOKEN[1], ARRAY_REPEAT_TOKEN, ARRAY_END_TOKEN],
  ),


  new TestCase('not-repeated-repeated',
    [1, 2, 2],
    [ARRAY_START_TOKEN, INTEGER_SMALL_POS_TOKEN[1], INTEGER_SMALL_POS_TOKEN[2], ARRAY_REPEAT_TOKEN, ARRAY_END_TOKEN],
  ),
  ...
  new TestCase('repeated-repeated-many-repeated-not-repeated',
    ...
    [
      ARRAY_START_TOKEN,
      INTEGER_SMALL_POS_TOKEN[1],
      ARRAY_REPEAT_TOKEN,
      INTEGER_SMALL_POS_TOKEN[2],
      ARRAY_REPEAT_TOKEN,
      ARRAY_REPEAT_TOKEN,
      ARRAY_REPEAT_TOKEN,
      ARRAY_REPEAT_MANY_TOKEN,
      '1',
      INTEGER_SMALL_POS_TOKEN[3],
      ARRAY_END_TOKEN
    ],
  ),
  ...
  new TestCase('deep-template-object',
    ...
    [
      ...
      INTEGER_SMALL_POS_TOKEN[2],
      INTEGER_SMALL_POS_TOKEN[3],
      INTEGER_SMALL_POS_TOKEN[4],
      INTEGER_SMALL_POS_TOKEN[5],
      INTEGER_SMALL_POS_TOKEN[6],
      INTEGER_SMALL_POS_TOKEN[7],
      INTEGER_SMALL_POS_TOKEN[8],
      TEMPLATE_OBJECT_FINAL,
      ARRAY_END_TOKEN,
    ],
  ),
