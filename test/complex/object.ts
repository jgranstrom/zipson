...
const testCases = [
  ...
  new TestCase('single-short-key-number',
    { x: 1 },
    [OBJECT_START_TOKEN, UNREFERENCED_STRING_TOKEN, 'x', UNREFERENCED_STRING_TOKEN, INTEGER_SMALL_POS_TOKEN[1], OBJECT_END_TOKEN]
  ),
  ...
  new TestCase('single-long-key-number',
    { some_key: 1 },
    [OBJECT_START_TOKEN, STRING_TOKEN, 'some_key', STRING_TOKEN, INTEGER_SMALL_POS_TOKEN[1], OBJECT_END_TOKEN]
  ),
